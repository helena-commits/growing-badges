-- Tabela para histórico de crachás emitidos
-- Execute este SQL no Supabase SQL Editor para criar a estrutura necessária
...
-- Criar políticas RLS para acesso anônimo
